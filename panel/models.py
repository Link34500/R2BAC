...
from accounts.models import UserDeleted

# Create your models here.


class Log(models.Model):
    user = models.ForeignKey(User,on_delete=models.SET_DEFAULT,default=UserDeleted(),related_name="log",related_query_name="logs")
    action = models.CharField(verbose_name="action effectuer",max_lengt=64)
